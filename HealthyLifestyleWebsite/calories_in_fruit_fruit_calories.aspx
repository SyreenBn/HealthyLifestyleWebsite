...
<title>Calories In Fruit Fruit Calories</title>
<style type="text/css">
.auto-style24 {
	font-size: 22.0pt;
...
<!-- #BeginEditable "body" -->
	...
	<table style="width: 75%; height: 327px">
		<tr>
			<td colspan="2" style="width: 386px; height: 22px">
			<div style="mso-element: para-border-div; mso-border-bottom-alt: solid #EDD6BB .75pt; background: white; border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium; padding-left: 0cm; padding-right: 0cm; padding-top: 0cm;">
				<h1 class="auto-style24" style="mso-border-bottom-alt: solid #EDD6BB .75pt; mso-padding-alt: 0cm 0cm 0cm 0cm">
				<strong>Calories In Fruit</strong></h1>
			</div>
			</td>
		</tr>
		<tr>
			<td style="width: 164px">
			<img alt="Calories in Fruit" src="img16.jpg" /></td>
			<td style="width: 386px">
			<p><span class="auto-style19">Fruit Calories</span><span class="apple-converted-space"><span class="auto-style22">&nbsp;</span></span><span class="auto-style22">are 
			made up of mostly simple carbohydrates, some proteins, and typically 
			very little fat - of course there are exceptions such as avocado.<o:p></o:p></span></p>
			<p><span class="auto-style18"><span class="auto-style20">Fruit is 
			nature's sugar (the sugar&nbsp;</span><span class="auto-style21">fructose</span><span class="auto-style20">), 
			and can be thought of as a "healthy" carb. However during a 
			fat-reducing program, all simple sugars should be eaten in 
			moderation. But don't go too overboard - fruit contains many healthy 
			nutrients - antioxidants, vitamins, and fiber</span></span><span style="font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;
color:#444444">.<o:p></o:p></span></p>
		...
		<tr>
			...
			<asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="داتا بيس/caloris.accdb" SelectCommand="SELECT DISTINCT * FROM [Grains]">
...
<div id="layer1" style="position: absolute; width: 606px; height: 369px; z-index: 1; left: -2px; top: 4px">
</div>
	&nbsp;</p>
...
<div id="layer7" style="position: absolute; width: 837px; height: 100px; z-index: 6; left: 7px; top: 307px; visibility: visible;">
  ...
  line-height:115%;font-family:&quot;Times New Roman&quot;,&quot;serif&quot;;mso-fareast-font-family:
  &quot;Times New Roman&quot;;color:#76A206">
					<span style="color:#76A206"><a href="about%20calory.html">Calories</a></span></span></u><span style="font-size:
